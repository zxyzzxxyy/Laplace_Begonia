<template>
	<view class="content-top">
		<swiper @change="swiperChange" :style="{height:height+'rpx'}" circular="true" autoplay="true" interval="8000" :previous-margin="previousMargin" :next-margin="nextMargin">
			<swiper-item v-for="(item,index) in swiperItems" :key="index" @click="a123(item.url)">
				<view class="content"
					:style="{height:height+'rpx',borderRadius:'0rpx'}">
					<image :src="item.img" mode="aspectFill" class="swiper-img"></image>
					<view class="mask"></view>
					<view class="written" @click="a123(item.url)">
